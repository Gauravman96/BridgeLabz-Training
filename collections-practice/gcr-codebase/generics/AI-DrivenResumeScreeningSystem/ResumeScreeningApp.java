...
public class ResumeScreeningApp {
    ...
    public static void main(String[] args) {
        ...
        Resume<SoftwareEngineer> resume1 = new Resume<>("gaurav", "RES001", seRole);
        Resume<DataScientist> resume2 = new Resume<>("rahul", "RES002", dsRole);
        Resume<ProductManager> resume3 = new Resume<>("abhay", "RES003", pmRole);
