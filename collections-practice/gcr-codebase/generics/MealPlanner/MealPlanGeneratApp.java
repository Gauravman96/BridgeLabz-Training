...
public class MealPlanGeneratApp {
    ...
    public static void main(String[] args) {
        ...
        generateMealPlan("Abhay", (List<Meal<? extends MealPlan>>) (List<?>) user1Meals);
        System.out.println();

        List<Meal<VeganMeal>> user2Meals = new ArrayList<>();
        user2Meals.add(tuesdayDinner);
        generateMealPlan("Rajput ji", (List<Meal<? extends MealPlan>>) (List<?>) user2Meals);
        System.out.println();
        ...
        generateMealPlan("Tanu (Mixed Plan)", mixedMeals);
        System.out.println();
    }
}